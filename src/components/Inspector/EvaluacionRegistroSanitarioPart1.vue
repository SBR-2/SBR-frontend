<template>
  <div class="app-container">
    ...
    <div class="main-content">
      ...
      <h2 class="mb-4 text-start title"><strong>Información del Solicitante del Producto</strong></h2>

      <!-- Información del Solicitante -->
      <div class="mb-4 text-start section">
        <h3 class="section-title"><strong>Información del Solicitante</strong></h3>
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Nombre</strong></h4>
            <p class="label-value">{{ solicitanteData.nombre }}</p>
          </div>
        </div>
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Correo</strong></h4>
            <p class="label-value">{{ solicitanteData.correo }}</p>
          </div>
          <div class="flex-item">
            <h4 class="sub-title"><strong>Teléfono</strong></h4>
            <p class="label-value">{{ solicitanteData.telefono }}</p>
          </div>
        </div>
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Dirección</strong></h4>
            <p class="label-value">{{ solicitanteData.direccion }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="mb-4 text-start section">
        <h3 class="section-title"><strong>Información del Titular del Producto</strong></h3>
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Nombre</strong></h4>
        ...
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Correo</strong></h4>
            <p class="label-value">{{ titularData.correo }}</p>
          </div>
          <div class="flex-item">
            <h4 class="sub-title"><strong>Teléfono</strong></h4>
            <p class="label-value">{{ titularData.telefono }}</p>
          </div>
        </div>
        <div class="flex-container">
          <div class="flex-item">
      ...
      <div class="mb-4 text-start section">
        <h3 class="section-title"><strong>Información del Representante Legal</strong></h3>
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Nombre</strong></h4>
            <p class="label-value">{{ representanteData.nombre }}</p>
          </div>
        </div>
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Cédula</strong></h4>
            <p class="label-value">{{ representanteData.cedula }}</p>
          </div>
          <div class="flex-item">
            <h4 class="sub-title"><strong>RNC</strong></h4>
            <p class="label-value">{{ representanteData.rnc }}</p>
          </div>
        </div>
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>¿Requiere representación para comercializar en Rep. Dom.?</strong></h4>
            <p class="label-value">{{ representanteData.requiereRepresentacion ? 'Sí' : 'No' }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="mb-4 text-start section">
        ...
        <button class="btn btn-primary btn-download" @click="descargarDocumento('poderRepresentacion')"><strong>Descargar</strong></button>
      </div>

      <!-- Certificado de Registro Mercantil -->
      <div class="mb-4 text-start section">
        <h3 class="section-title"><strong>Certificado de Registro Mercantil</strong></h3>
        <button class="btn btn-primary btn-download" @click="descargarDocumento('registroMercantil')"><strong>Descargar</strong></button>
      </div>

      <!-- Información de Persona de Contacto -->
      <div class="mb-4 text-start section">
        <h3 class="section-title"><strong>Información de Persona de Contacto</strong></h3>
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Nombre</strong></h4>
        ...
        <div class="flex-container">
          <div class="flex-item">
            <h4 class="sub-title"><strong>Correo</strong></h4>
            <p class="label-value">{{ contactoData.correo }}</p>
          </div>
          <div class="flex-item">
            <h4 class="sub-title"><strong>Teléfono</strong></h4>
            <p class="label-value">{{ contactoData.telefono }}</p>
          </div>
        </div>
      </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    const solicitudId = ref(route.params.id);

    // Datos de ejemplo
    const solicitanteData = ref({
      nombre: 'Pedro Páramo',
      correo: 'pedropar@gmail.com',
      telefono: '809-974-9432',
    ...
    const representanteData = ref({
      nombre: 'Pedro Páramo',
      cedula: '001-1234567-8',
      rnc: '123456789',
      requiereRepresentacion: true
    });
    ...
    const irASiguiente = () => {
      router.push(`/evaluacion-registro-sanitario-part2/${solicitudId.value}`);
    };
